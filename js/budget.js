...
function renderBudgetCard(b) {
    ...
    return `
    <div class="budget-card ${over ? 'budget-card--over' : ''}" id="budget-card-${id}" data-id="${id}">
      <div class="budget-card__header">
        ...
        <div class="budget-card__actions">
          <button class="budget-card__edit-btn" data-id="${id}" type="button">${isMobile ? 'Save' : 'Edit'}</button>
          <button class="budget-card__remove-btn" data-id="${id}" type="button">Remove</button>
        </div>
      </div>
      ...
      <div class="budget-edit-form" id="edit-form-${id}">
        <input
        ...
        />
        <button class="budget-save-btn" data-id="${id}" data-cat="${category}" type="button">Save</button>
      </div>
    </div>`;
}
